...
<li><a href="../medico/medico_historial.php">Historial  Medico</a></li>
                 ...
                 <?php
                      ...
                      ?>
                                  ...
                                  <li><a><i class="fa fa-database"></i>Gastos Asilo<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
...
<li><a href="../gastos/gastos_categoria.php">Categoria gastos</a></li>
                    ...
                    <?php
                      ...
                      ?>
                      <li><a><i class="fa fa-database"></i> Pacientes Asilo<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
