...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-10-2022 a las 03:15:36
...
INSERT INTO `detalles_pedido` (`id_detalles`, `id_pedido`, `id_producto`, `cantidad`, `id_cliente`) VALUES
(1, 9, 1, '1', 20);
...
(269, 5, 'se ha desconectado el sistema en ', '2022-10-14 06:08:12'),
(270, 5, 'se ha desconectado el sistema en ', '2022-10-14 06:22:01'),
(271, 5, 'se ha desconectado el sistema en ', '2022-10-14 06:22:54'),
(272, 5, 'se ha desconectado el sistema en ', '2022-10-14 19:13:32'),
(273, 5, 'se ha desconectado el sistema en ', '2022-10-14 19:13:42'),
(274, 5, 'se ha desconectado el sistema en ', '2022-10-14 19:14:44'),
(275, 21, 'se ha desconectado el sistema en ', '2022-10-14 19:15:20'),
(276, 5, 'se ha desconectado el sistema en ', '2022-10-14 19:16:12'),
(277, 21, 'se ha desconectado el sistema en ', '2022-10-14 19:16:34'),
(278, 5, 'se ha desconectado el sistema en ', '2022-10-14 19:22:34'),
(279, 21, 'se ha desconectado el sistema en ', '2022-10-14 19:22:48'),
(280, 5, 'se ha desconectado el sistema en ', '2022-10-21 17:56:57'),
(281, 5, 'se ha desconectado el sistema en ', '2022-10-21 17:59:56'),
(282, 5, 'se ha desconectado el sistema en ', '2022-10-21 18:11:24'),
(283, 5, 'se ha desconectado el sistema en ', '2022-10-28 19:49:27');
...
(9, '2022-10-15', 5, 20, 'Contado', 34, 34, 21);
...
(21, 'brands', 'a1Bz20ydqelm8m1wql8a4488c177d9dc8c3da7c745c89ca214', '', 'medico', 'brands', 'juarez ', '55991364', 'brandsj12@gmail.com'),
(22, 'wilson', 'a1Bz20ydqelm8m1wql8a4488c177d9dc8c3da7c745c89ca214', '', 'medico', 'Wilson', 'Guilles', '55555444', 'wilsonguilles@gmail,com');
...
--
ALTER TABLE `detalles_pedido`
  MODIFY `id_detalles` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
